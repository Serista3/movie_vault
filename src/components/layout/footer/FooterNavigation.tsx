...
// --- CONSTANTS ---
const BASE_CLASS = "text-secondary-light bg-primary-light py-6 px-4 sm:py-8 md:py-10 border-t border-gray-dark flex flex-col items-center gap-6";
...
export default function FooterNavigation() {
  ...
  return (
    <footer className={BASE_CLASS}>
      <Logo />
      {/* --- FOOTER COLUMNS --- */}
      <div className="flex justify-center w-full gap-8 sm:gap-10 md:gap-12 border-b border-secondary-light pb-6 sm:pb-8 md:pb-10">
